    ...
    return (
      <nav className="navbar sticky-top navbar-toggleable-sm navbar-inverse bg-danger">
        ...
        <div className="container">
          <Link className="text-center" style={{ boxShadow: "none" }} to='/'><h1 className="navbar-brand mb-0">{title}</h1></Link>
          <div className="navbar-collapse collapse" id="navbarColor02" aria-expanded="false">
            <ul className="navbar-nav mr-auto">
              <li className={location.pathname === "/" ? "nav-item active" : "nav-item"}>
                <Link to='/' style={{ boxShadow: "none" }} className="nav-link">Home</Link>
              </li>
              <li className={location.pathname === "/profile/" ? "nav-item active" : "nav-item"}>
                <Link to='/profile/' style={{ boxShadow: "none" }} className="nav-link">Profile</Link>
              </li>
              <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle" style={{ boxShadow: "none" }} id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Link
                </a>
